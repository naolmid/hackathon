...
async function main() {
  ...
  const resources = [
    ...
    // Lab 4 Computers
    { name: 'Computer 001', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 002', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 003', type: 'COMPUTER', quantity: 1, currentQuantity: 0, locationId: lab4!.id },
    { name: 'Computer 004', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 005', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 006', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 007', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 008', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 009', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 010', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 011', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 012', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 013', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 014', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 015', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 016', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 017', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 018', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 019', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    { name: 'Computer 020', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab4!.id },
    
    // Lab 9 Computers
    { name: 'Computer 021', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 022', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 023', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 024', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 025', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 026', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 027', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 028', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 029', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 030', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 031', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 032', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 033', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 034', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 035', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 036', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 037', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 038', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 039', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 040', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 041', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 042', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 043', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 044', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 045', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 046', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 047', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 048', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
    { name: 'Computer 049', type: 'COMPUTER', quantity: 1, currentQuantity: 1, locationId: lab9!.id },
